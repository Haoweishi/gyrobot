...
void Robot::AutonomousPeriodic() {
	...
	SmartDashboard::PutNumber("Gyro Position", g->GetAngle());
	if (g->GetAngle() > 3) {
		//veering right
		RobotMap::driveLeftMotor->Set(-(speed-(difference*0.01)));
		RobotMap::driveRightMotor->Set(speed+(difference*0.01));
	} else if (g->GetAngle() < -3) {
		//veering left
		RobotMap::driveLeftMotor->Set(-(speed-(difference*0.01)));
		RobotMap::driveRightMotor->Set(speed+(difference*0.01));
	} else {
...
void Robot::TeleopPeriodic() {
	...
	RobotMap::driveLeftMotor->Set(-.25);
	RobotMap::driveRightMotor->Set(.25);
